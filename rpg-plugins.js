...
function loadPluginItems() {
    ...
    // Registrar efectos adicionales del plugin en GameEffects
    if(typeof GameEffects !== 'undefined') {
        var pluginEffects = {
            thunder:{id:'thunder',name:'Trueno',icon:'⚡',dmg:'1d6',turns:1,color:'#ffd700'},
            curse:{id:'curse',name:'Maldición',icon:'💀',dmg:1,turns:4,color:'#4b0082'},
            blind:{id:'blind',name:'Ceguera',icon:'🌑',dmg:0,turns:2,color:'#2f2f2f'},
            stun:{id:'stun',name:'Aturdido',icon:'💫',dmg:0,turns:1,color:'#daa520'},
            burn:{id:'burn',name:'Quemadura',icon:'🔥',dmg:2,turns:3,color:'#ff8c00'},
            slow:{id:'slow',name:'Lento',icon:'🐌',dmg:0,turns:2,color:'#708090'},
            weak:{id:'weak',name:'Debilidad',icon:'💔',dmg:0,turns:3,color:'#8b4513'},
            drain:{id:'drain',name:'Drenar',icon:'🩸',dmg:1,turns:2,color:'#800000'},
            confuse:{id:'confuse',name:'Confusión',icon:'😵',dmg:0,turns:2,color:'#ff69b4'}
        };
        Object.keys(pluginEffects).forEach(function(k) {
            if(!GameEffects.list[k]) GameEffects.list[k] = pluginEffects[k];
        });
        console.log('✨ Efectos del plugin registrados en GameEffects');
    }
    ...
    var recipes = [
        ...
        {id:'plg_rec_elf_bread',name:'Pan Élfico',icon:'🧝',result:'plg_food_elf_bread',ingredients:[{id:'i7',qty:3},{id:'plg_herb_rare',qty:2},{id:'plg_food_honey',qty:2}]}
    ];
