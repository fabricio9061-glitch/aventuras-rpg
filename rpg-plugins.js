...
function loadPluginItems() {
    ...
    var enemies = [
        ...
        {id:'plg_bat',name:'Murciélago',health:6,damage:'1d3',difficulty:7,armor:0,speed:16,icon:'🦇',loot:[3,8],drops:[{itemId:'plg_bat_wing',chance:60}],regions:['mazmorra','plg_catacumbas'],canGroup:true,groupMin:3,groupMax:5,groupChance:70},
        {id:'plg_spider',name:'Araña',health:10,damage:'1d4',difficulty:8,armor:0,speed:13,icon:'🕷️',effect:'poison',loot:[5,15],drops:[{itemId:'plg_spider_silk',chance:60},{itemId:'plg_venom',chance:15}],regions:['bosque','mazmorra'],canGroup:true,groupMin:2,groupMax:4,groupChance:40},
        ...
        {id:'plg_goblin',name:'Goblin',health:10,damage:'1d6',difficulty:8,armor:1,speed:11,icon:'👺',loot:[8,18],drops:[{itemId:'plg_goblin_ear',chance:60},{itemId:'plg_copper',chance:20}],regions:['bosque','mazmorra'],canGroup:true,groupMin:2,groupMax:5,groupChance:60},
        ...
        {id:'plg_wolf',name:'Lobo',health:14,damage:'1d6',difficulty:9,armor:0,speed:14,icon:'🐺',loot:[10,20],drops:[{itemId:'plg_wolf_pelt',chance:50},{itemId:'plg_fang',chance:30}],regions:['bosque'],canGroup:true,groupMin:2,groupMax:4,groupChance:50},
        ...
        // Tier 2
        {id:'plg_orc',name:'Orco',health:22,damage:'1d8',difficulty:10,armor:2,speed:10,icon:'👹',loot:[15,30],drops:[{itemId:'plg_leather',chance:40},{itemId:'plg_iron',chance:20}],regions:['bosque','montana'],canGroup:true,groupMin:2,groupMax:4,groupChance:50},
        ...
        {id:'plg_golem',name:'Golem',health:40,damage:'1d10',difficulty:13,armor:5,speed:6,icon:'🗿',loot:[30,50],drops:[{itemId:'plg_golem_core',chance:25},{itemId:'plg_iron',chance:60}],regions:['plg_torre','mazmorra'],canGroup:false},
        {id:'plg_harpy',name:'Arpía',health:22,damage:'1d8',difficulty:11,armor:0,speed:16,icon:'🦅',loot:[20,40],drops:[{itemId:'plg_feather',chance:50},{itemId:'plg_claw',chance:30}],regions:['montana'],canGroup:true,groupMin:2,groupMax:3,groupChance:35},
        {id:'plg_crab',name:'Cangrejo',health:35,damage:'1d10',difficulty:12,armor:5,speed:8,icon:'🦀',loot:[20,45],drops:[{itemId:'plg_shell',chance:70},{itemId:'plg_pearl',chance:10}],regions:['plg_abismo','pantano'],canGroup:false},
        ...
        {id:'plg_ogre',name:'Ogro',health:50,damage:'2d6',difficulty:13,armor:2,speed:7,icon:'👹',loot:[30,60],drops:[{itemId:'plg_leather',chance:40},{itemId:'plg_bone',chance:30}],regions:['montana','pantano'],canGroup:false},
        ...
        {id:'plg_mermaid',name:'Sirena',health:28,damage:'1d8',difficulty:12,armor:0,speed:13,icon:'🧜',loot:[30,55],drops:[{itemId:'plg_mermaid_scale',chance:40},{itemId:'plg_pearl',chance:25}],regions:['plg_abismo'],canGroup:false},
        ...
        {id:'plg_vampire',name:'Vampiro',health:40,damage:'1d8',difficulty:14,armor:1,speed:14,icon:'🧛',loot:[35,70],drops:[{itemId:'plg_vampire_fang',chance:50},{itemId:'plg_shadow',chance:30}],regions:['plg_catacumbas'],canGroup:false},
        {id:'plg_necromancer',name:'Nigromante',health:25,damage:'1d8',difficulty:14,armor:0,speed:10,icon:'🧙‍♂️',usesMana:true,loot:[30,60],drops:[{itemId:'plg_book_empty',chance:20},{itemId:'plg_shadow',chance:40},{itemId:'plg_skull',chance:30}],regions:['plg_catacumbas','plg_cementerio'],canGroup:false},
        {id:'plg_wizard',name:'Mago Oscuro',health:30,damage:'2d6',difficulty:14,armor:0,speed:11,icon:'🧙',usesMana:true,loot:[35,65],drops:[{itemId:'plg_book_empty',chance:25},{itemId:'plg_crystal',chance:30}],regions:['plg_torre'],canGroup:false},
        ...
        {id:'plg_elemental',name:'Elem. Arcano',health:35,damage:'1d10',difficulty:14,armor:2,speed:11,icon:'✨',loot:[30,55],drops:[{itemId:'plg_crystal',chance:50},{itemId:'plg_magic_essence',chance:15}],regions:['plg_torre'],canGroup:false},
